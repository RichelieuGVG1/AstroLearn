...
def description():
	...
	7:['Этот древнегреческий персонаж по ошибке на охоте застрелил собственную мать, а позже в его честь назвали созвездие *Волопас*. Из-за его очертаний, созвездие часто называют парашютистом.'],
